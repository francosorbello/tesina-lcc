...
\end{itemize}
\par Para ello, se divide el proceso en 5 etapas: iniciación, pre-producción, producción, post-producción y lanzamiento. Cada una de estas etapas tiene un tiempo estimado de duración y una serie de acciones a realizar. A continuación se detallan las etapas y sus acciones. 

...
\par Esta etapa comenzó analizando los proyectos realizados durante la etapa de proptotipado. Del feedback recibido se extrajeron las siguientes conclusiones:
\begin{itemize}
...
\par Lo importante a destacar es que esta etapa está marcada por un proceso fuerte de prueba y error, donde ideas pasan por varias etapas hasta llegar a un producto divertido o interesante. 
\par Esto dificulta medir el progreso del proyecto durante esta etapa. Sin embargo, tanto Lemarchand como Anderson proponen realizar playtesting para contrarrestar esta incertidumbre.

...
\begin{itemize}
    \item El juego en itch.io: \url{https://francosorbello.itch.io/fuente-paraiso}
    \item Repositorio del proyecto: \url{https://github.com/francosorbello/fuente-paraiso}
\end{itemize} 
